...
import { LAUNCH_AT } from '@/middleware';
...
export default function ComingSoonPage() {
  ...
  return (
    ...
    >
      {/* Brand mark */}
      <p
        className="font-sans text-[10px] tracking-[0.45em] uppercase mb-20"
        style={{ color: '#c9a96e' }}
      >
        Lumée Maison
      </p>
      ...
      {time.done ? (
        <div className="text-center">
          <p
            ...
            style={{ fontSize: 'clamp(2rem, 6vw, 4rem)', color: '#c9a96e' }}
          >
            We&apos;re Live
          </p>
          <a
            href="/"
            className="block mt-6 font-sans text-[11px] tracking-[0.35em] uppercase underline underline-offset-4"
            style={{ color: '#6b6b6b' }}
          >
          ...
          {units.map(({ value, label }, i) => (
            <Fragment key={label}>
              ...
              <div className="flex flex-col items-center gap-3">
                ...
                <span
                  className="font-sans text-[8px] sm:text-[9px] tracking-[0.35em] uppercase"
                  style={{ color: '#b5aba0' }}
                >
                  {label}
                </span>
      ...
      {/* Footer tagline */}
      <p
        className="font-sans text-[9px] tracking-[0.3em] uppercase mt-14"
        style={{ color: '#b5aba0' }}
      >
