...
export const FAQ_ITEMS: FaqItem[] = [
  {
    ...
    a: {
      en: 'Shipping is $35 flat rate from South Korea to anywhere in the world. We ship via FedEx, DHL, EMS, or UPS — whichever is fastest and most reliable for your destination.\n\nUSA note: A free FedEx account number is required for standard $35 shipping. This also applies to US territories — Puerto Rico, Guam, the US Virgin Islands, American Samoa and the Northern Mariana Islands — because they require a US FedEx account. Without one, FedEx Priority is available at $65.',
      ru: 'Доставка стоит $35 фиксированно из Южной Кореи в любую точку мира. Мы отправляем через FedEx, DHL, EMS или UPS — в зависимости от вашей страны.\n\nДля клиентов из США и территорий США (Пуэрто-Рико, Гуам, Виргинские о-ва США, Американское Самоа, Северные Марианские о-ва): требуется бесплатный номер аккаунта FedEx. Без него доступна доставка FedEx Priority за $65.',
      fr: `La livraison est à un tarif unique de $35 depuis la Corée du Sud vers le monde entier. Nous expédions via FedEx, DHL, EMS ou UPS — selon l'option la plus rapide et la plus fiable pour votre destination.\n\nNote pour les États-Unis et les territoires américains (Porto Rico, Guam, Îles Vierges américaines, Samoa américaines, Îles Mariannes du Nord) : un numéro de compte FedEx gratuit est requis pour la livraison standard à $35. À défaut, FedEx Priority est disponible à $65.`,
      es: `El envío tiene una tarifa única de $35 desde Corea del Sur a cualquier parte del mundo. Enviamos mediante FedEx, DHL, EMS o UPS, según la opción más rápida y fiable para su destino.\n\nNota para EE. UU. y territorios de EE. UU. (Puerto Rico, Guam, Islas Vírgenes de EE. UU., Samoa Americana, Islas Marianas del Norte): se requiere un número de cuenta FedEx gratuito para el envío estándar de $35. Sin él, FedEx Priority está disponible por $65.`,
    },
  },
  {
    id: 2,
  ...
  },
  {
    ...
    a: {
      en: `Every order is packed thoroughly and with great care before it leaves us. Once it's handed to the courier, though, the delivery process is outside our control, so we're unable to offer replacements, refunds, or store credit for damage that occurs in transit. If your box arrives damaged, please photograph it on arrival and contact your local courier to report it, as any transit claim is handled on their side.`,
      ru: `Каждый заказ тщательно и бережно упаковывается перед отправкой. Однако после передачи курьеру процесс доставки находится вне нашего контроля, поэтому мы не можем предложить замену, возврат средств или магазинный кредит за повреждения, возникшие при транспортировке. Если ваша коробка пришла повреждённой, сфотографируйте её сразу при получении и обратитесь к местному курьеру, чтобы сообщить о проблеме, так как любые претензии по доставке рассматриваются на их стороне.`,
      fr: `Chaque commande est emballée minutieusement et avec le plus grand soin avant de quitter nos locaux. Cependant, une fois le colis remis au transporteur, le processus de livraison échappe à notre contrôle ; nous ne pouvons donc pas proposer de remplacement, de remboursement ou d'avoir pour les dommages survenus pendant le transport. Si votre colis arrive endommagé, veuillez le photographier dès la réception et contacter votre transporteur local pour le signaler, car toute réclamation liée au transport est traitée de leur côté.`,
      es: `Cada pedido se embala de forma minuciosa y con el mayor cuidado antes de salir de nuestras instalaciones. Sin embargo, una vez entregado al transportista, el proceso de entrega queda fuera de nuestro control, por lo que no podemos ofrecer reemplazos, reembolsos ni crédito en tienda por los daños ocurridos durante el transporte. Si su caja llega dañada, fotografíela en cuanto la reciba y contacte a su transportista local para informar del problema, ya que cualquier reclamación de transporte se gestiona por su parte.`,
    },
  },
  {
    id: 14,
